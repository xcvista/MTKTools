...
#import "NSData+MTKCompression.h"

#import <zlib.h>
#import <bzlib.h>

@implementation NSData (MTKCompression)

- (NSData *)zlibCompress
{
    return [self zlibCompressWithLevel:MTKCompressionLevelDefault];
}
...
- (NSData *)gzipCompress
{
    return [self gzipCompressWithLevel:MTKCompressionLevelDefault];
}
...
- (NSData *)bzipCompress
{
    return [self bzipCompressWithLevel:MTKCompressionLevelDefault];
}
